package com.kintaiTeam14.kintaiTeam14.aop;
...
public class LoggingAspect {
     ...
     */
    @Before("execution(* com.kintaiTeam14.kintaiTeam14..*(..))")
     ...
     * @param result 戻り値
     */
    @AfterReturning(pointcut = "execution(* com.kintaiTeam14.kintaiTeam14..*(..))", returning = "result")
     ...
     * @param ex 発生した例外
     */
    @AfterThrowing(pointcut = "execution(* com.kintaiTeam14.kintaiTeam14..*(..))", throwing = "ex")
